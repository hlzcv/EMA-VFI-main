...
- pyiqa (optional, for NIQE and CLIP-IQA metrics)
...
For custom sequence-folder datasets (e.g. BS-ERGB), you can evaluate with additional metrics:
...
```shell
python benchmark/BS_ERGB.py --model ours --path /where/is/your/BS-ERGB --metrics psnr,ssim,lpips,niqe,clip-iqa
```
